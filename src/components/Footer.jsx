        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-xl font-bold text-white">Nikah Manzil</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2"><Phone size={15} className="mt-0.5 shrink-0 text-gold-400" /> +92 300 1234567</li>
