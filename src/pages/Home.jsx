      ...
      <section className="relative overflow-hidden bg-ink-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
          ...
          >
            ...
            <Button to="/search" variant="outline" size="lg" className="!border-white/40 !text-white hover:!bg-white hover:!text-ink-900">
              Browse Profiles
            </Button>
          </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-maroon-500 to-rose-600 px-6 sm:px-14 py-14 sm:py-20 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button to="/register" variant="white" size="lg">
              Register Now
            </Button>
            <Button to="/contact" variant="outline" size="lg" className="!border-white/50 !text-white hover:!bg-white hover:!text-maroon-500">
              Contact Us
            </Button>
          </div>
        </div>
